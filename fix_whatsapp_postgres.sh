#!/bin/bash
# Script para configurar Evolution API con PostgreSQL (Solución Definitiva)

PROJECT_ID="travel-recomender"
ZONE="us-east1-b"
INSTANCE="evolution-api-server"

echo "🔧 SOLUCIONANDO PROBLEMA DE QR - CAMBIANDO A POSTGRESQL"
echo "========================================================"
echo ""
echo "El error anterior 'Database provider redis invalid' indica que"
echo "Evolution API v2 requiere PostgreSQL como base de datos principal."
echo ""
...
# Limpiar volúmenes antiguos para evitar conflictos
...
print("\n📱 Generando QR code con PostgreSQL...")
